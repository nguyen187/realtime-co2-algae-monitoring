...
def run(Inputs):
    ...
    # Inputs = [json.loads(x.replace("'",'"')) for x in Inputs]
    data = pd.DataFrame(list(Inputs))
    # print('dataaaaaaaaaaaa',data)
    Intensity = data.values
    X1 = savgol_filter(Intensity, 17, polyorder = 3,deriv=2)
