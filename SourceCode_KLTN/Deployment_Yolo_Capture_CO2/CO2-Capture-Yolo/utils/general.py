...
def check_imgsz(imgsz, stride=32, min_dim=2):
    # Ensure imgsz is a multiple of stride and greater than min_dim
    new_size = max(min_dim, (imgsz // stride) * stride)
    if new_size != imgsz:
        print(f"Image size {imgsz} adjusted to {new_size} to be a multiple of stride {stride}")
    return new_size
